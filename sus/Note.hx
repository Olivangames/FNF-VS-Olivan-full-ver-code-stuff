	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?noteType:Int = 0)
		{
			...
			if (PlayState.SONG.song.toLowerCase() == 'red' || PlayState.SONG.song.toLowerCase() == 'pvp')
            {
								frames = Paths.getSparrowAtlas('newNote/REDNOTES');
					...
					else if (PlayState.SONG.song.toLowerCase() == 'ez' || PlayState.SONG.song.toLowerCase() == 'joker')
            {
								frames = Paths.getSparrowAtlas('newNote/BLUENOTES');
								var fuckingSussy = Paths.getSparrowAtlas('ICE_NOTES');
						...
						switch(noteType)
						{
							case 2:
							{
								...
								animation.addByPrefix('greenScroll', 'greencrack0');
								animation.addByPrefix('redScroll', 'redcrack0');
								animation.addByPrefix('blueScroll', 'bluecrack0');
								animation.addByPrefix('purpleScroll', 'purplecrack0');
					...
					switch (PlayState.SONG.noteStyle)
			{
				...
				default:
						...
						var fuckingSussy = Paths.getSparrowAtlas('ICE_NOTES');
						var fuckingSussy = Paths.getSparrowAtlas('CodeNotes');
						var fuckingSussy = Paths.getSparrowAtlas('Glitch');
						for(amogus in fuckingSussy.frames)
							{
								this.frames.pushFrame(amogus);
							}
						...
						switch(noteType)
						{
							...
							case 3:
							{
								frames = Paths.getSparrowAtlas('CodeNotes');
